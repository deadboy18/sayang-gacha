...
const CONFIG = {
  ...
  codes: [
    ...
    { code: "BHAI",           tokens: 2 },
    { code: "HYENA",          tokens: 2 },
    { code: "SUSHIZANMAI",    tokens: 3 },
    { code: "BLACKDRESS",     tokens: 3 },
    { code: "DEADMANWALKING", tokens: 3 },
    { code: "1AMCALL",        tokens: 3 },
    { code: "COTTAGEFRIES",   tokens: 3 },
    { code: "60PERCENT",      tokens: 5 },
    { code: "HOLDMYHAND",     tokens: 5 },
    { code: "ALWAYSPICKUP",   tokens: 5 },
    { code: "SPIRALSAFELY",   tokens: 5 },  
  ],
